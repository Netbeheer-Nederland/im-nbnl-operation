...
Accumulator -> ACDCTerminal: Terminal


Accumulator -> PowerSystemResource: PowerSystemResource
...
//| [[slots_table.AccumulatorValues]]<<AccumulatorValues,`AccumulatorValues`>>
| 0..* +
...
| xref::class/AccumulatorValue.adoc[`AccumulatorValue`] | xref::class/AccumulatorValue.adoc#Accumulator[`Accumulator`]
